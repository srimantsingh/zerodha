...
function ProductsPage() {
  return (
    <>
      ...
      />
       <RightSection imageURL="media/console.png"
        ...
        productDescription="Buy direct mutual funds online, commission-free, delivered
         directly to your Demit account. Enjoy the investment experience on
     ...
     Want to know more about our technology stack? Check out the<a className="text-decoration-none" href=" Zerodha.tech"> Zerodha.tech</a> blog.</p>
